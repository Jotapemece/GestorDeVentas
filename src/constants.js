...
const SEL = {
  ...
  clientDeudaUsd: '#client-deuda-usd',
  ...
  dailyAbonos: '#daily-abonos',
  dailyAbonosTotal: '#daily-abonos-total',
  dailyAbonosBody: '#daily-abonos-body',
  ...
  movimientosLoadMore: '#movimientos-load-more',
  ...
  tetrisModal: '#tetris-modal',
  tetrisClose: '#tetris-close',
  tetrisBoard: '#tetris-board',
  tetrisNext: '#tetris-next',
  tetrisScore: '#tetris-score',
  tetrisLines: '#tetris-lines',
  tetrisLevel: '#tetris-level',
  tetrisStatus: '#tetris-status',
  tetrisPauseBtn: '#tetris-pause-btn',
  tetrisRestartBtn: '#tetris-restart-btn',
  tetrisBtn: '#tetris-btn',
  tetrisPaletteBtns: '.tetris-palette-btn',
  tetrisOverlay: '#tetris-overlay',
  tetrisOverScore: '#tetris-over-score',
  tetrisOverLines: '#tetris-over-lines',
  tetrisOverLevel: '#tetris-over-level',
  tetrisFrame: '#tetris-frame',
  tetrisField: '.tetris-field',
